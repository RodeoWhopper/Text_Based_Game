...
public class CharacterInitService implements CharacterInitInterface {

    @Override
    public Entity init(String NAME, int LEVEL, int EXP, String RACE, CharacterClass CLASS, Inventory INVENTORY) {
        ...
        try{
            if(RACE == "ORC") {
                ...
                }else if(CLASS.getName() == "WHITE MAGE") {
                    c.setStat_strength((c.getBase_strength()+1));
                    c.setStat_dexterity(c.getBase_dexterity()+1);
                    c.setStat_endurance(c.getBase_endurance()+1);
                ...
                if(CLASS.getName() == "WARRIOR") {
                    ...
                    c.setStat_intelligence((c.getBase_intelligence() * 2));
                    c.setStat_charisma(c.getBase_charisma() + 1);
                }else if(CLASS.getName() == "BLACK MAGE") {
                    c.setStat_strength((c.getBase_strength()+1));
                    c.setStat_dexterity(c.getBase_dexterity()+1);
                    c.setStat_endurance(c.getBase_endurance()+1);
